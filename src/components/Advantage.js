            ...
            <div className="adv-modal">
              <div className="wrap">
                ...
                <div className="border">
                  ...
                  <div className="txt1 bt"></div>
                  <div className="txt2">
                    Blue&nbsp;Blue亲子游泳以专业自救与水中教育为内核，根据中国婴幼儿的生理发育、心理特征与行为模式，构建科学专业的八大递进式课程体系，包含亲子亲密课、抚触舒展课、水感培养课、亲子益智课、成长进阶课、水中技能课、水中自救课、专业训练课；精细划分为海星、章鱼、海马、海龟、海豚、鲨鱼六大技能阶段；配以安全创新的多样化教具，辅以基础、社交、环境适应、闭气反射等六大维度的全方位教学评分体系，动态跟踪教学成效，提升教学质量，协以技能认定升阶考试，考核教学
                  </div>
                  <div className="txt3">
                    成果，致力于让每一位学员都学有成效。
                  </div>
            ...
            <div className="adv-modal">
              <div className="wrap">
                ...
                <div className="border">
                  ...
                  <div className="txt1 bt">Blue&nbsp;Blue集成化管理系统</div>
                  <div className="txt2">
