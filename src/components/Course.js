            ...
            <div className="cour-modal">
              ...
              <div className="card">
                ...
                <div className="txt2">
                  ...
                  及时应答宝宝并带入逻辑性言语，可促进宝宝的语言和社会性应答能力的发展。
                </div>
          ...
          >
            <div className="cour-modal">
              ...
              <div className="card">
                ...
                <div>
                  5-7岁的儿童独立性强，需要一个平等对话的平台，让他们像小大人一样去学习如何为人处世，学习承担与帮助、学习享受成功也接受失败。在反复进行标准化动作训练的过程中，家长和教练充分尊重儿童的意愿，在儿童学习规范动作的基础上，让儿童能够自己设定目标，并努力去完成，鼓励他们自己摸索并自主选择最适合自己游泳的方式。
                </div>
              </div>
            </div>
          </Modal>
